ADMIN_EMAIL = 'admin@futurexco.com'
ADMIN_PASSWORD = 'P3gajahan'
...
if Rails.env == 'development'
  NORMAL_PASSWORD = 'P3gajahan'

  foo = Identity.create(email: 'foo@futurexco.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'bar@futurexco.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
